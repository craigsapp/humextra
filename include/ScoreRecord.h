...
class ScoreRecord : public ScoreParameters {
   public:
      ...
      void            setSystemPosition      (int objidx);
      void            setSystemPos           (int objidx);

      int             getStaffPosition       (void);
      int             getStaffPos            (void);
      void            setStaffPosition       (int objidx);
      void            setStaffPos            (int objidx);
