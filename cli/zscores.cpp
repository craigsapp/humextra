...
void      printRawNumbers       (vector<Datum> data, int style);
void      extractNumbers        (HumdrumFile& infile, int field,
                                 vector<Datum>& data);
double    getMean               (vector<Datum>& data);
double    getStandardDeviation  (double mean, vector<Datum>& data);
double    getSampleSD           (double mean, vector<Datum>& data);
void      adjustData            (vector<Datum>& data, double mean, double sd,
                                 int reverse);
void      printDataSingle       (vector<Datum>& data, int field,
                                 HumdrumFile& infile, double mean, double sd);
void      printDataReplace      (vector<Datum>& data, int field,
                                 HumdrumFile& infile, double mean, double sd);
void      printDataPrepend      (vector<Datum>& data, int field,
                                 HumdrumFile& infile, double mean, double sd);
void      printDataAppend       (vector<Datum>& data, int field,
                                 HumdrumFile& infile, double mean, double sd);
...
void printDataReplace(vector<Datum>& data, int field, HumdrumFile& infile,
...
void printDataAppend(vector<Datum>& data, int field, HumdrumFile& infile,
			double mean, double sd) {
...
void printDataPrepend(vector<Datum>& data, int field, HumdrumFile& infile,
			double mean, double sd) {
...
void printDataSingle(vector<Datum>& data, int field, HumdrumFile& infile,
			double mean, double sd) {
...
void adjustData(vector<Datum>& data, double mean, double sd, int reverse) {
	int i;
